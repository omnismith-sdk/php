...
class Configuration
{
     ...
     * @var string
     */
    protected $host = 'https://api.omnismith.io/v1';
    ...
    {
        $report  = 'PHP SDK (Omnismith\Sdk) Debug Report:' . PHP_EOL;
        $report .= '    OS: ' . php_uname() . PHP_EOL;
        $report .= '    PHP Version: ' . PHP_VERSION . PHP_EOL;
        $report .= '    The version of the OpenAPI document: 1.0.6' . PHP_EOL;
