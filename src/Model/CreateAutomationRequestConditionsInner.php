...
/**
 * CreateAutomationRequestConditionsInner Class Doc Comment
 *
 * @category Class
 * @package  Omnismith\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateAutomationRequestConditionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateAutomationRequest_conditions_inner';
     ...
     * Sets attributeId
     *
     * @param string $attributeId Attribute UUID to evaluate
     *
     * @return self
     */
     ...
     * Sets mode
     *
     * @param string $mode Evaluation mode: current value, absolute numeric change, or percentage change
     *
     * @return self
     */
