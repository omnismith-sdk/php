...
/**
 * ToggleAutomationRequest Class Doc Comment
 *
 * @category Class
 * @package  Omnismith\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class ToggleAutomationRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ToggleAutomationRequest';
     ...
     * Sets isEnabled
     *
     * @param bool $isEnabled Whether the automation rule should be active (true) or paused (false)
     *
     * @return self
     */
