...
/**
 * ReplaceEntityRequest Class Doc Comment
 *
 * @category Class
 * @description Payload for replacing all non-metric attribute values of an existing entity
 * @package  Omnismith\Sdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ReplaceEntityRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ReplaceEntityRequest';
     ...
     * Gets attributes
     *
     * @return array<string,\Omnismith\Sdk\Model\EntityAttributesInputValue>
     */
