 ...
 *
 * @category Class
 * @description Payload for rotating a refresh token and obtaining a new JWT access token
 * @package  Omnismith\Sdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class RefreshTokenRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets refreshToken
     *
     * @param string $refreshToken The active refresh token string to rotate
     *
     * @return self
     */
