...
class AutomationExecutionResponseActionResultsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('action_index', $data ?? [], null);
    ...
    {
        return $this->container['action_index'];
    }

    /**
     * Sets action_index
     *
     * @param int|null $action_index action_index
     *
     * @return self
     */
    public function setActionIndex($action_index)
    {
        if (is_null($action_index)) {
            throw new \InvalidArgumentException('non-nullable action_index cannot be null');
        }
        $this->container['action_index'] = $action_index;
