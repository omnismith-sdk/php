...
/**
 * ApproveOAuthAuthorization200Response Class Doc Comment
 *
 * @category Class
 * @package  Omnismith\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class ApproveOAuthAuthorization200Response implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'approveOAuthAuthorization_200_response';
     ...
     * Sets code
     *
     * @param string|null $code Single-use authorization code
     *
     * @return self
     */
     ...
     * Sets redirectUri
     *
     * @param string|null $redirectUri Client redirection URI
     *
     * @return self
     */
     ...
     * Sets callbackUrl
     *
     * @param string|null $callbackUrl Complete redirection callback URL with code and state parameters
     *
     * @return self
     */
