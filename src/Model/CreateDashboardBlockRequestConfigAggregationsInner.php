...
/**
 * CreateDashboardBlockRequestConfigAggregationsInner Class Doc Comment
 *
 * @category Class
 * @package  Omnismith\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class CreateDashboardBlockRequestConfigAggregationsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'CreateDashboardBlockRequest_config_aggregations_inner';
     ...
     * Sets field
     *
     * @param string|null $field Attribute slug or UUID to reduce. Required for every op except count, which must omit it.
     *
     * @return self
     */
