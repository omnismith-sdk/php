 ...
 *
 * @category Class
 * @description Metadata describing a system or custom user role
 * @package  Omnismith\Sdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
...
class RoleResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * Sets id
     *
     * @param string|null $id Unique UUIDv7 identifier of the role
     *
     * @return self
     */
     ...
     * Sets name
     *
     * @param string|null $name Display name of the role
     *
     * @return self
     */
     ...
     * Sets isOwner
     *
     * @param bool|null $isOwner Whether this is the root project owner role with full administrative privileges
     *
     * @return self
     */
     ...
     * Sets createdAt
     *
     * @param \DateTime|null $createdAt Timestamp when the role was created
     *
     * @return self
     */
