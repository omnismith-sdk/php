...
/**
 * TemplateResponseAttributesInner Class Doc Comment
 *
 * @category Class
 * @package  Omnismith\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class TemplateResponseAttributesInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TemplateResponse_attributes_inner';
     ...
     * Sets defaultValue
     *
     * @param string|null $defaultValue Per-template default value for newly created entities (or null). For List attributes, stores the list item UUID.
     *
     * @return self
     */
