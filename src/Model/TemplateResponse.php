...
class TemplateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('attribute_ids', $data ?? [], null);
     ...
     * Sets attribute_ids
     *
     * @param string[]|null $attribute_ids attribute_ids
     *
     * @return self
     */
    public function setAttributeIds($attribute_ids)
    {
        if (is_null($attribute_ids)) {
            throw new \InvalidArgumentException('non-nullable attribute_ids cannot be null');
        }
