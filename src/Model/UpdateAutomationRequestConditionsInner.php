...
/**
 * UpdateAutomationRequestConditionsInner Class Doc Comment
 *
 * @category Class
 * @package  Omnismith\Sdk
 * @author   OpenAPI Generator team
 ...
 */
class UpdateAutomationRequestConditionsInner implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'UpdateAutomationRequest_conditions_inner';
    ...
    public const MODE_CHANGE_ABSOLUTE = 'change_absolute';
    public const MODE_CHANGE_PERCENT = 'change_percent';
    ...
    public function getModeAllowableValues()
    {
        return [
            self::MODE_CURRENT,
            self::MODE_CHANGE_ABSOLUTE,
            self::MODE_CHANGE_PERCENT,
        ];
    }
     ...
     * Sets attributeId
     *
     * @param string|null $attributeId Attribute UUID to evaluate
     *
     * @return self
     */
     ...
     * Sets value
     *
     * @param mixed|null $value Expected comparison value
     *
     * @return self
     */
     ...
     * Sets mode
     *
     * @param string|null $mode Evaluation mode: current value, absolute numeric change, or percentage change
     *
     * @return self
     */
