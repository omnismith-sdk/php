...
class CheckoutResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('checkoutUrl', $data ?? [], null);
    ...
    {
        return $this->container['checkoutUrl'];
    }

    /**
     * Sets checkoutUrl
     *
     * @param string|null $checkoutUrl URL to redirect user to complete checkout
     *
     * @return self
     */
    public function setCheckoutUrl($checkoutUrl)
    {
        if (is_null($checkoutUrl)) {
            throw new \InvalidArgumentException('non-nullable checkoutUrl cannot be null');
        }
        $this->container['checkoutUrl'] = $checkoutUrl;
     ...
     * Sets checkoutId
     *
     * @param string|null $checkoutId LemonSqueezy checkout session ID
     *
     * @return self
     */
