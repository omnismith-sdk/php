...
/**
 * WorkspaceViewResponseSort Class Doc Comment
 *
 * @category Class
 * @description Active sort configuration
 * @package  Omnismith\Sdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class WorkspaceViewResponseSort implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'WorkspaceViewResponse_sort';
     ...
     * Sets active
     *
     * @param string|null $active Target field or column sorted by
     *
     * @return self
     */
