...
class ProjectUserResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('left_at', $data ?? [], null);
    }
     ...
     * Sets role_name
     *
     * @param string|null $role_name Human-readable role name
     *
     * @return self
     */
     ...
     * Sets user_name
     *
     * @param string|null $user_name User's display name
     *
     * @return self
     */
    ...
    {
        return $this->container['left_at'];
    }

    /**
     * Sets left_at
     *
     * @param \DateTime|null $left_at left_at
     *
     * @return self
     */
    public function setLeftAt($left_at)
    {
        if (is_null($left_at)) {
            array_push($this->openAPINullablesSetToNull, 'left_at');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('left_at', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['left_at'] = $left_at;
