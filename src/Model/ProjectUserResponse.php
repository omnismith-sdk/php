...
/**
 * ProjectUserResponse Class Doc Comment
 *
 * @category Class
 * @description User in Project details
 * @package  Omnismith\Sdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ProjectUserResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ProjectUserResponse';
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('leftAt', $data ?? [], null);
    }
     ...
     * Sets roleName
     *
     * @param string|null $roleName Human-readable role name
     *
     * @return self
     */
    ...
    {
        if (is_null($roleName)) {
            throw new \InvalidArgumentException('non-nullable roleName cannot be null');
        }
     ...
     * Sets joinedAt
     *
     * @param \DateTime|null $joinedAt joinedAt
     *
     * @return self
     */
    ...
    {
        return $this->container['leftAt'];
    }

    /**
     * Sets leftAt
     *
     * @param \DateTime|null $leftAt leftAt
     *
     * @return self
     */
    ...
    {
        if (is_null($leftAt)) {
            array_push($this->openAPINullablesSetToNull, 'leftAt');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('leftAt', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['leftAt'] = $leftAt;
