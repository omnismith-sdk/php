...
/**
 * EntityAttributesInputValueAnyOf1 Class Doc Comment
 *
 * @category Class
 * @description Operation object: apply an atomic operation to the stored value instead of overwriting it. Number attributes and metrics only; a never-set value counts as 0.
 * @package  Omnismith\Sdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class EntityAttributesInputValueAnyOf1 implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'EntityAttributesInput_value_anyOf_1';
