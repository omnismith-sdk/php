...
/**
 * ActionLayoutResponse Class Doc Comment
 *
 * @category Class
 * @description Visual UI presentation details for an entity action.
 * @package  Omnismith\Sdk
 * @author   OpenAPI Generator team
 * @link     https://openapi-generator.tech
 * @implements \ArrayAccess<string, mixed>
 */
class ActionLayoutResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'ActionLayoutResponse';
     ...
     * Sets icon
     *
     * @param string|null $icon Material icon identifier for action buttons and dialogs
     *
     * @return self
     */
     ...
     * Sets sortOrder
     *
     * @param int $sortOrder Display sorting rank in action menus
     *
     * @return self
     */
