...
class ProjectResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('showTour', $data ?? [], null);
    ...
    {
        return $this->container['showTour'];
    }

    /**
     * Sets showTour
     *
     * @param bool|null $showTour Whether the interactive tour should be shown for this project
     *
     * @return self
     */
    public function setShowTour($showTour)
    {
        if (is_null($showTour)) {
            throw new \InvalidArgumentException('non-nullable showTour cannot be null');
        }
        $this->container['showTour'] = $showTour;
     ...
     * Sets ownerEmail
     *
     * @param string|null $ownerEmail Email of the project owner
     *
     * @return self
     */
    public function setOwnerEmail($ownerEmail)
    {
        if (is_null($ownerEmail)) {
            array_push($this->openAPINullablesSetToNull, 'ownerEmail');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('ownerEmail', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
