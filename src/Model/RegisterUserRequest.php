...
class RegisterUserRequest implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    public function __construct(?array $data = null)
    {
        ...
        $this->setIfExists('captchaToken', $data ?? [], null);
    }
    ...
    {
        return $this->container['captchaToken'];
    }

    /**
     * Sets captchaToken
     *
     * @param string|null $captchaToken CAPTCHA response token (required for anonymous/public signups)
     *
     * @return self
     */
    public function setCaptchaToken($captchaToken)
    {
        if (is_null($captchaToken)) {
            array_push($this->openAPINullablesSetToNull, 'captchaToken');
        } else {
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('captchaToken', $nullablesSetToNull);
            if ($index !== FALSE) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
        }
        $this->container['captchaToken'] = $captchaToken;
